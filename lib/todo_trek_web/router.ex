defmodule TodoTrekWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {TodoTrekWeb.Layouts, :root}
  ...
  scope "/", TodoTrekWeb do
    ...
    # live_session :admins, on_mount: {MyAppWTodoTrekWebeb.InitAssigns, :admin} do
    #   scope "/admin", TodoTrekWeb.Admin do
